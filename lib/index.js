...
function set$2(target, key, val) {
  if (process.env.NODE_ENV !== 'production' && (isUndef$1(target) || isPrimitive$1(target))) {
...
if (process.env.NODE_ENV !== 'production') {
  ...
  var hasProxy = typeof Proxy !== 'undefined' && isNative$1(Proxy);
...
function updateListeners(on, oldOn, add, remove$$1, createOnceHandler, vm) {
  ...
  for (name in on) {
    ...
    if (isUndef$1(cur)) {
      process.env.NODE_ENV !== 'production' && warn$2("Invalid handler for event \"" + event.name + "\": got " + String(cur), vm);
  ...
  if (isDef(attrs) || isDef(props)) {
    for (var key in propOptions) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        if (key !== keyInLowerCase && attrs && hasOwn$1(attrs, keyInLowerCase)) {
...
function normalizeChildren(children) {
  return isPrimitive$1(children) ? [createTextVNode(children)] : Array.isArray(children) ? normalizeArrayChildren(children) : undefined;
}
...
function resolveScopedSlots$1(fns, // see flow/vnode
...
function _createElement(context, tag, data, children, normalizationType) {
  if (isDef(data) && isDef(data.__ob__)) {
    process.env.NODE_ENV !== 'production' && warn$2("Avoid using observed data object as vnode data: " + JSON.stringify(data) + "\n" + 'Always create fresh vnode data objects in each render!', context);
...
function resolveAsyncComponent(factory, baseCtor) {
  ...
  if (owner && !isDef(factory.owners)) {
    ...
    var reject = once(function (reason) {
      process.env.NODE_ENV !== 'production' && warn$2("Failed to resolve async component: " + String(factory) + (reason ? "\nReason: " + reason : ''));
...
var Watcher = function Watcher(vm, expOrFn, cb, options, isRenderWatcher) {
  ...
  if (typeof expOrFn === 'function') {
    ...
    if (!this.getter) {
      this.getter = noop;
      process.env.NODE_ENV !== 'production' && warn$2("Failed watching path: \"" + expOrFn + "\" " + 'Watcher only accepts simple dot-delimited paths. ' + 'For full control, use a function instead.', vm);
    }
  }
...
function initData(vm) {
  ...
  while (i--) {
    ...
    if (props && hasOwn$1(props, key)) {
      process.env.NODE_ENV !== 'production' && warn$2("The data property \"" + key + "\" is already declared as a prop. " + "Use prop default value instead.", vm);
...
function actuallySetSelected(el, binding, vm) {
  ...
  if (isMultiple && !Array.isArray(value)) {
    process.env.NODE_ENV !== 'production' && warn$2("<select multiple v-model=\"" + binding.expression + "\"> " + "expects an Array value for its binding, but got " + Object.prototype.toString.call(value).slice(8, -1), vm);
    return;
  }
...
function createSlotProxy(vm, slotName) {
  return function () {
    ...
    if (!vm.$scopedSlots[slotName]) {
      if (process.env.NODE_ENV !== 'production') return warn$1("slots." + slotName + "() got called outside of the \"render()\" scope", vm);
      return;
    }
...
function updateVmAttrs(vm, ctx) {
  ...
  if (!attrBindings) {
    ...
    proxy(ctx, 'attrs', {
      ...
      set: function () {
        process.env.NODE_ENV !== 'production' && warn$1("Cannot assign to '$attrs' because it is a read-only property", vm);
      }
    });
  }
  ...
  function createSetupContext(vm) {
    ...
    propsPlain.forEach(function (key) {
      ...
      proxy(ctx, key, {
        ...
        set: function () {
          process.env.NODE_ENV !== 'production' && warn$1("Cannot assign to '" + key + "' because it is a read-only property", vm);
        }
      });
    });
...
const __vue_scope_id__$2 = "data-v-b4afa89c";
/* module identifier */
...
const __vue_inject_styles__$1 = function (inject) {
  if (!inject) return;
  inject("data-v-49910312_0", {
    source: ".crafter-button[data-v-49910312] {\n  box-shadow: 0px 3px 6px #00000029;\n  font-weight: 500;\n  line-height: \"1.2\";\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  position: relative;\n  white-space: nowrap;\n  vertical-align: middle;\n  outline: none;\n  cursor: pointer;\n}\n.crafter-button[data-v-49910312]:hover:not(.disabled) {\n  filter: brightness(90%);\n}\n.crafter-button.disabled[data-v-49910312] {\n  color: #d8d8d8;\n}\n\n/*# sourceMappingURL=IconButton.vue.map */",
    map: {
      "version": 3,
...
const __vue_scope_id__$1 = "data-v-49910312";
/* module identifier */
...
const __vue_scope_id__ = "data-v-7c454bc1";
/* module identifier */
...
exports.Box = __vue_component__$2;
exports.IconButton = __vue_component__$1;
exports.SampleComponent = __vue_component__$3;
exports.Toggle = __vue_component__;
